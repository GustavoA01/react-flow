...
export const ModalFooter = ({ concluded }: { concluded: boolean }) => {
  return (
    <>
      <p className="mt-8 mb-8 text-zinc-500 font-semibold text-center">
        {concluded
      ...
      <DialogClose
        className={`flex justify-center mx-auto font-semibold py-4 rounded-md w-40 border bg-cyan-50 cursor-pointer hover:bg-zinc-100`}
      >
