...
export const WonMedal = () => (
  <Card className="group cursor-pointer hover:scale-105 hover:shadow-primary transition-all duration-300">
    <CardContent className="space-y-2 select-none flex flex-col items-center">
      <img
        src={"https://res-console.cloudinary.com/dbyal02d7/thumbnails/transform/v1/image/upload/Y19maWxsLGhfMjAwLHdfMjAw/v1/Q2hhdEdQVF9JbWFnZV8yNl9kZV9hZ28uX2RlXzIwMjZfMTZfNDBfNDNfaTk1emVh/template_primary"}
        alt="Imagem medalha"
